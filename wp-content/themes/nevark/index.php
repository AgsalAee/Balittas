...
nevark_add_custom_title_content( 'pre', 'index.php' );
if ( nevark_titlearea_top() ) {
	nevark_loopmeta_header_img( 'index', false );
	get_template_part( 'template-parts/loop-meta' ); // Loads the template-parts/loop-meta.php template to display Title Area with Meta Info (of the loop)
	nevark_add_custom_title_content( 'post', 'index.php' );
} else {
	nevark_loopmeta_header_img( 'index', true );
}

// Template modification Hook
do_action( 'nevark_before_content_grid', 'index.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'index' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'nevark_main_start', 'index.php' );
			...
			if ( have_posts() ) :
				...
				// Template modification Hook
				do_action( 'nevark_loop_start', 'index.php' );
				...
				// Template modification Hook
				do_action( 'nevark_loop_end', 'index.php' );

				echo '</div>';

				// Template modification Hook
				do_action( 'nevark_before_loop_nav', 'index.php' );
			...
			// Template modification Hook
			do_action( 'nevark_main_end', 'index.php' );
			?>
