...
add_filter( 'hoot_attr_header',   'nevark_attr_header',   7, 2 );
add_filter( 'hoot_attr_menu',     'nevark_attr_menu',     7, 2 );
add_filter( 'hoot_attr_content',  'nevark_attr_content',  7    );
add_filter( 'hoot_attr_sidebar',  'nevark_attr_sidebar',  7, 2 );
add_filter( 'hoot_attr_branding', 'nevark_attr_branding', 7    );

/* New Theme Filters */
add_filter( 'hoot_attr_page-wrapper',      'nevark_attr_page_wrapper',      7    );
add_filter( 'hoot_attr_topbar',            'nevark_attr_topbar',            7    );
add_filter( 'hoot_attr_header-part',       'nevark_attr_header_part',       7, 2 );
add_filter( 'hoot_attr_header-aside',      'nevark_attr_header_aside',      7    );
add_filter( 'hoot_attr_sidebar-header-sidebar', 'nevark_attr_sidebar_header_sidebar', 7 );
add_filter( 'hoot_attr_below-header',      'nevark_attr_below_header',      7    );
add_filter( 'hoot_attr_main',              'nevark_attr_main',              7    );
add_filter( 'hoot_attr_frontpage-grid',    'nevark_attr_frontpage_grid',    7    );
add_filter( 'hoot_attr_frontpage-content', 'nevark_attr_frontpage_content', 7    );
add_filter( 'hoot_attr_frontpage-area',    'nevark_attr_frontpage_area',    7, 2 );
add_filter( 'hoot_attr_loop-meta-wrap',    'nevark_attr_loop_meta_wrap',    7, 2 );
add_filter( 'hoot_attr_loop-meta',         'nevark_attr_loop_meta',         7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-title',        'nevark_attr_loop_title',        7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-description',  'nevark_attr_loop_description',  7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_content-wrap',      'nevark_attr_content_wrap',      7, 2 );
add_filter( 'hoot_attr_sidebar-wrap',      'nevark_attr_sidebar_wrap',      7, 2 );
add_filter( 'hoot_attr_sub-footer',        'nevark_attr_sub_footer',        7    );
add_filter( 'hoot_attr_post-footer',       'nevark_attr_post_footer',       7    );
 ...
 * @return array
 */
function nevark_attr_header( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_menu( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function nevark_attr_content( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];

	$layout_class = nevark_layout_class( 'content' );
 ...
 * @return array
 */
function nevark_attr_sidebar( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	if ( !empty( $context ) && ( $context == 'primary' || $context == 'secondary' ) ) {
		$layout_class = nevark_layout_class( "sidebar" );
		if ( !empty( $layout_class ) )
			$attr['class'] .= $layout_class;
	}
 ...
 * @return array
 */
function nevark_attr_branding( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function nevark_attr_page_wrapper( $attr ) {
	...
	$classes = apply_filters( 'nevark_attr_page_wrapper_plugins', array( 'hoot-cf7-style', 'hoot-mapp-style', 'hoot-jetpack-style' ) );
 ...
 * @return array
 */
function nevark_attr_topbar( $attr ) {
	$attr['id'] = 'topbar';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' topbar';
	return $attr;
 ...
 * @return array
 */
function nevark_attr_header_part( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_header_aside( $attr ) {
...
/**
 * Header Aside Widget Area attributes.
 *
 * @since 1.0
 * @access public
 * @param array $attr
 * @return array
 */
function nevark_attr_sidebar_header_sidebar( $attr ) {
	$attr['id'] = 'sidebar-header-sidebar';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' sidebar-header-sidebar';
	return $attr;
}
 ...
 * @return array
 */
function nevark_attr_below_header( $attr ) {
 ...
 * @return array
 */
function nevark_attr_main( $attr ) {
	$attr['id'] = 'main';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' main';
	return $attr;
 ...
 * @return array
 */
function nevark_attr_frontpage_grid( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function nevark_attr_frontpage_content( $attr ) {
 ...
 * @return array
 */
function nevark_attr_frontpage_area( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_loop_meta_wrap( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_loop_meta( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_loop_title( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_loop_description( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_content_wrap( $attr, $context ) {
 ...
 * @return array
 */
function nevark_attr_sidebar_wrap( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function nevark_attr_sub_footer( $attr ) {
	$attr['id'] = 'sub-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function nevark_attr_post_footer( $attr ) {
	$attr['id'] = 'post-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
