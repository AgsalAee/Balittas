...
/* Add custom scripts. */
add_action( 'wp_enqueue_scripts', 'nevark_enqueue_scripts', 9 );
...
add_action( 'wp_enqueue_scripts', 'nevark_localize_script', 9 );
...
add_action( 'wp_enqueue_scripts', 'nevark_base_enqueue_scripts', 11 );
...
add_action( 'wp_enqueue_scripts', 'nevark_enqueue_styles', 10 );

/* Dequeue font awesome */
add_action( 'wp_enqueue_scripts', 'nevark_dequeue_fontawesome', 99 );
 ...
 * @return void
 */
if ( !function_exists( 'nevark_enqueue_scripts' ) ) :
function nevark_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'nevark_localize_script' ) ) :
function nevark_localize_script() {
 ...
 * @return void
 */
if ( !function_exists( 'nevark_base_enqueue_scripts' ) ) :
function nevark_base_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'nevark_enqueue_styles' ) ) :
function nevark_enqueue_styles() {

	/* Load Google Fonts if 'google-fonts' is active. */
	$style_uri = nevark_google_fonts_enqueue_url();
	if ( $style_uri )
		wp_enqueue_style( 'nevark-googlefont', $style_uri, array(), null );
 ...
 * @return void
 */
if ( !function_exists( 'nevark_dequeue_fontawesome' ) ) :
function nevark_dequeue_fontawesome() {
