...
add_action( 'after_setup_theme', 'nevark_includes', 10 );
...
function nevark_includes() {
	...
	/* Load TGMPA Class */
	if ( apply_filters( 'nevark_load_tgmpa', file_exists( hoot_data()->incdir . 'admin/class-tgm-plugin-activation.php' ) ) )
		require_once( hoot_data()->incdir . 'admin/class-tgm-plugin-activation.php' );
	/* Load Customizer Options */
	if ( apply_filters( 'nevark_customize_load_trt', file_exists( hoot_data()->incdir . 'admin/trt-customize-pro/class-customize.php' ) ) )
	...
	/* Load the about page. */
	if ( apply_filters( 'nevark_load_about', file_exists( hoot_data()->incdir . 'admin/about.php' ) ) )
...
add_filter( 'hoot_get_mods', 'nevark_transition_get_mods', 2 );
 ...
 * @return void
 */
function nevark_transition_get_mods( $mods ) {
