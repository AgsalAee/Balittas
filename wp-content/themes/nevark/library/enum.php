...
function hoot_enum_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'nevark' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'nevark' ),
		'repeat-y'  => __( 'Repeat Vertically', 'nevark' ),
		'repeat'    => __( 'Repeat All', 'nevark' ),
		);
...
function hoot_enum_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'nevark' ),
		'top center'    => __( 'Top Center', 'nevark' ),
		'top right'     => __( 'Top Right', 'nevark' ),
		'center left'   => __( 'Middle Left', 'nevark' ),
		'center center' => __( 'Middle Center', 'nevark' ),
		'center right'  => __( 'Middle Right', 'nevark' ),
		'bottom left'   => __( 'Bottom Left', 'nevark' ),
		'bottom center' => __( 'Bottom Center', 'nevark' ),
		'bottom right'  => __( 'Bottom Right', 'nevark')
		);
...
function hoot_enum_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'nevark' ),
		'fixed'  => __( 'Fixed in Place', 'nevark'),
		);
...
function hoot_enum_background_size() {
	$default = array(
		'original' => __( 'Original Size', 'nevark' ),
		'contain'  => __( 'Fit to Screen', 'nevark'),
		'cover'    => __( 'Fill Screen', 'nevark'),
		);
...
function hoot_enum_background_type() {
	$default = array(
		'predefined' => __( 'Predefined Pattern', 'nevark' ),
		'custom'     => __( 'Custom Image', 'nevark' ),
		);
...
function hoot_enum_font_styles() {
	$default = array(
		'none'                      => __( 'None', 'nevark' ),
		'italic'                    => __( 'Italic', 'nevark' ),
		'bold'                      => __( 'Bold', 'nevark' ),
		'bold italic'               => __( 'Bold Italic', 'nevark' ),
		'semibold'                  => __( 'SemiBold', 'nevark' ),
		'semibold italic'           => __( 'SemiBold Italic', 'nevark' ),
		'lighter'                   => __( 'Light', 'nevark' ),
		'lighter italic'            => __( 'Light Italic', 'nevark' ),
		'uppercase'                 => __( 'Uppercase', 'nevark' ),
		'uppercase italic'          => __( 'Uppercase Italic', 'nevark' ),
		'uppercase bold'            => __( 'Uppercase Bold', 'nevark' ),
		'uppercase bold italic'     => __( 'Uppercase Bold Italic', 'nevark' ),
		'uppercase semibold'        => __( 'Uppercase SemiBold', 'nevark' ),
		'uppercase semibold italic' => __( 'Uppercase SemiBold Italic', 'nevark' ),
		'uppercase lighter'         => __( 'Uppercase Light', 'nevark' ),
		'uppercase lighter italic'  => __( 'Uppercase Light Italic', 'nevark' )
		);
...
function hoot_enum_social_profiles( $skype = false, $email = true ) {
	$social = array(
		'fa-amazon'         => __( 'Amazon', 'nevark' ),
		'fa-android'        => __( 'Android', 'nevark' ),
		'fa-apple'          => __( 'Apple', 'nevark' ),
		'fa-bandcamp'       => __( 'Bandcamp', 'nevark' ),
		'fa-behance'        => __( 'Behance', 'nevark' ),
		'fa-bitbucket'      => __( 'Bitbucket', 'nevark' ),
		'fa-btc'            => __( 'BTC', 'nevark' ),
		'fa-buysellads'     => __( 'BuySellAds', 'nevark' ),
		'fa-codepen'        => __( 'Codepen', 'nevark' ),
		'fa-codiepie'       => __( 'Codie Pie', 'nevark' ),
		'fa-contao'         => __( 'Contao', 'nevark' ),
		'fa-dashcube'       => __( 'Dash Cube', 'nevark' ),
		'fa-delicious'      => __( 'Delicious', 'nevark' ),
		'fa-deviantart'     => __( 'Deviantart', 'nevark' ),
		'fa-digg'           => __( 'Digg', 'nevark' ),
		'fa-dribbble'       => __( 'Dribbble', 'nevark' ),
		'fa-dropbox'        => __( 'Dropbox', 'nevark' ),
		'fa-eercast'        => __( 'Eercast', 'nevark' ),
		'fa-envelope'       => __( 'Email', 'nevark' ),
		'fa-etsy'           => __( 'Etsy', 'nevark' ),
		'fa-facebook'       => __( 'Facebook', 'nevark' ),
		'fa-flickr'         => __( 'Flickr', 'nevark' ),
		'fa-forumbee'       => __( 'Forumbee', 'nevark' ),
		'fa-foursquare'     => __( 'Foursquare', 'nevark' ),
		'fa-free-code-camp' => __( 'Free Code Camp', 'nevark' ),
		'fa-get-pocket'     => __( 'Pocket (getpocket)', 'nevark' ),
		'fa-github'         => __( 'Github', 'nevark' ),
		'fa-google'         => __( 'Google', 'nevark' ),
		'fa-google-plus'    => __( 'Google Plus', 'nevark' ),
		'fa-google-wallet'  => __( 'Google Wallet', 'nevark' ),
		'fa-houzz'          => __( 'Houzz', 'nevark' ),
		'fa-imdb'           => __( 'IMDB', 'nevark' ),
		'fa-instagram'      => __( 'Instagram', 'nevark' ),
		'fa-jsfiddle'       => __( 'JS Fiddle', 'nevark' ),
		'fa-lastfm'         => __( 'Last FM', 'nevark' ),
		'fa-leanpub'        => __( 'Leanpub', 'nevark' ),
		'fa-linkedin'       => __( 'Linkedin', 'nevark' ),
		'fa-meetup'         => __( 'Meetup', 'nevark' ),
		'fa-mixcloud'       => __( 'Mixcloud', 'nevark' ),
		'fa-paypal'         => __( 'Paypal', 'nevark' ),
		'fa-pinterest'      => __( 'Pinterest', 'nevark' ),
		'fa-quora'          => __( 'Quora', 'nevark' ),
		'fa-reddit'         => __( 'Reddit', 'nevark' ),
		'fa-rss'            => __( 'RSS', 'nevark' ),
		'fa-scribd'         => __( 'Scribd', 'nevark' ),
		'fa-skype'          => __( 'Skype', 'nevark' ),
		'fa-slack'          => __( 'Slack', 'nevark' ),
		'fa-slideshare'     => __( 'Slideshare', 'nevark' ),
		'fa-snapchat'       => __( 'Snapchat', 'nevark' ),
		'fa-soundcloud'     => __( 'Soundcloud', 'nevark' ),
		'fa-spotify'        => __( 'Spotify', 'nevark' ),
		'fa-stack-exchange' => __( 'Stack Exchange', 'nevark' ),
		'fa-stack-overflow' => __( 'Stack Overflow', 'nevark' ),
		'fa-steam'          => __( 'Steam', 'nevark' ),
		'fa-stumbleupon'    => __( 'Stumbleupon', 'nevark' ),
		'fa-trello'         => __( 'Trello', 'nevark' ),
		'fa-telegram-plane' => __( 'Telegram', 'nevark' ),
		'fa-tripadvisor'    => __( 'Trip Advisor', 'nevark' ),
		'fa-tumblr'         => __( 'Tumblr', 'nevark' ),
		'fa-twitch'         => __( 'Twitch', 'nevark' ),
		'fa-twitter'        => __( 'Twitter', 'nevark' ),
		'fa-viadeo'         => __( 'Viadeo', 'nevark' ),
		'fa-vimeo-square'   => __( 'Vimeo', 'nevark' ),
		'fa-vk'             => __( 'VK', 'nevark' ),
		'fa-wikipedia-w'    => __( 'Wikipedia', 'nevark' ),
		'fa-windows'        => __( 'Windows', 'nevark' ),
		'fa-wordpress'      => __( 'WordPress', 'nevark' ),
		'fa-xing'           => __( 'Xing', 'nevark' ),
		'fa-y-combinator'   => __( 'Y Combinator', 'nevark' ),
		'fa-yelp'           => __( 'Yelp', 'nevark' ),
		'fa-youtube'        => __( 'Youtube', 'nevark' ),
	);
...
function hoot_fonticons_list( $return = 'icons' ) {
	...
	if ( 'sections' == $return ) :
		return apply_filters( 'hoot_fonticons_sections', array(
			'fonticons' => __('Font Icons', 'nevark'),
			'brands'    => __('Brands', 'nevark'),
			)
		);
	endif;
