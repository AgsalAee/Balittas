...
class Hoot_Taxonomy_Field {
	...
	public function taxonomy_columns_header( $defaults ){
		$defaults['hoot_term_img']  = __( 'Featured Image', 'nevark' );
		return $defaults;
	}
	...
	public function taxonomy_column( $columns, $column, $id ){
		if ( 'hoot_term_img' === $column ) {
			...
			$columns .= '<img data-id="'.$thumbnail_id.'" src="' . esc_url( $image ) . '" alt="' . esc_attr__( 'Thumbnail', 'nevark' ) . '" class="hoot_term_img" width="35px" />';
		}
		return $columns;
	}
	...
	public function add_taxonomy_field( $term ) {
		...
		?><div class="form-field">
			<label for="hoot_term_img"><?php esc_html_e( 'Featured Image', 'nevark' ); ?></label>
			...
			<button type="button" class="hoot_term_img_add button"><?php esc_html_e( 'Upload/Add image', 'nevark' ); ?></button>
			<button type="button" class="hoot_term_img_remove button"><?php esc_html_e( 'Remove image', 'nevark' ); ?></button>
		</div><?php
	}
