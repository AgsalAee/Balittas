...
if ( is_active_sidebar( 'hoot-header' ) || current_user_can( 'edit_theme_options' ) ) :
	...
	<div <?php hoot_attr( 'header-sidebar', '', 'inline-nav js-search hgrid-stretch' ); ?>>
		...
		do_action( 'nevark_sidebar_start', 'header-sidebar' );

		?>
		<aside <?php hoot_attr( 'sidebar-header-sidebar' ); // hoot_attr( 'sidebar', 'header-sidebar' ); ?>>
			<?php
		...
		// Template modification Hook
		do_action( 'nevark_sidebar_end', 'header-sidebar' );
